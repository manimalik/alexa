...
class App extends Component {
  ...
  handleDateChange = value => {
    ...
    if( moment(this.state.feedTime, 'h:mm a',true).isValid() ) {
      this.setState({isEnable : false});
    } else {
      this.setState({isEnable : true});
    }
    this.setState({
      selected: value,
      briefDateTime: moment(
        (value.start + "").replace("00:00:00", this.state.feedTime)
      ).format("MMM DD, YYYY hh:mm a")
    });
  };
  ...
  handlePostFormSubmit = () => {
    ...
    fetch("files/additem.php", {
      ...
      .then(responseJson => {
        ...
        this.setState({ postForm: false, postTitle:'', postText:'', record_id:'0' });
        ...
        responseJson.forEach(element => {
          rowsData.push([
            ...
            element.audio == "" ? (
              ...
              <ReactAudioPlayer
                src={
                  "https://briefify.coldsmoke.co/alex/uploads/" + element.audio
                }
                controls
                style={{
                  minWidth: "500px"
                ...
                <FormLayout>
                  ...
                  <Popover.Pane>
                    <TextField
                      value={feedTime}
                      prefix={<Icon source="calendar" color="black" />}
                      onChange={this.handleTimeChange("feedTime")}
                    />
                  </Popover.Pane>
                </FormLayout>
              </Popover>
                ...
                {!!audio && is_textbriefing == "0" && (
                  <TextContainer>
                    ...
                    >
                      <ReactAudioPlayer
                        src={
                          "https://briefify.coldsmoke.co/alex/uploads/" + audio
                        }
                        controls
                        style={{
                          minWidth: "500px"
  ...
  _onRecordingError = err => {
    ...
    if (isChrome) {
      ...
      window.open("/alex/external/record", "_blank");
    }
